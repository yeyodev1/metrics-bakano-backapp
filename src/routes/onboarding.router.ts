...
import { acceptVideoResponsibilities, submitContract, checkOnboardingStatus, markMeetingScheduled, markResourcesCompleted, downloadContract } from "../controllers/onboarding.controller";
